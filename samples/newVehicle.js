...
var initiateWrite = function () {
  setTimeout(function () {
    ...
    var out1 = Buffer.from([0x8e, 0x04, 0x00, 0x00]);
    var out2 = Buffer.from([0x00, 0x00, 0x00, 0x00]);
    var out3 = Buffer.from([0x00, 0x00, 0x00, 0x00]);
    var out4 = Buffer.from([0x00, 0x00, 0x00, 0x00]);
...
console.log(
  "YOU HAVE 5 SECONDS TO PLACE ONE GAME DISC ONTO TOY PAD BEFORE IT IS WRITTEN"
);
initiateWrite();
